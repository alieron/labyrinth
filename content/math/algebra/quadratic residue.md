...
### Summary
Legendre symbol, function to check for quadratic residue for [prime](/labyrinth/notes/math/algebra/prime_numbers) moduli
$$
\begin{gather*}
...
$$
### Application
Deriving the legendre symbol with [fermat's little theorem](/labyrinth/notes/math/algebra/fermat's_little_theorem)
$$
\begin{align*}
