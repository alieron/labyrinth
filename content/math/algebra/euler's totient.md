...
### Summary
For [prime numbers](/labyrinth/notes/math/algebra/prime_numbers)
$$
\varphi(p) = p-1
$$

Euler's theorem, generalisation of [fermat's little theorem](/labyrinth/notes/math/algebra/fermat's_little_theorem)
$$
\begin{gather*}
...
$$
### Concept
Number of integers [coprime](/labyrinth/notes/math/algebra/greatest_common_divisor#^449690) with $n$
$$
\begin{gather*}
...
Deriving congruence in exponentiation with the [modulo](/labyrinth/notes/math/algebra/modulo) exponentiation rule
$$
\begin{gather*}
