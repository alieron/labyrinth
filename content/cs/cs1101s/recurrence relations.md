...
\end{align*}
$$
- deriving via [arithmetic](/labyrinth/notes/math/ma1301/arithmetic_series) progression
...
\end{align*}
$$
- deriving via [geometric](/labyrinth/notes/math/ma1301/geometric_series) progression
...
\end{align*}
$$
> note $2^{\log_{2}n} = n, \ \frac{n}{2^{\log_{2}n}} = 1$
### Application
